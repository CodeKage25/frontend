...
import { ChevronRight, Heart, LayoutGrid, LogOut, Mail, Settings } from "lucide-react"
...
const Topbar = () => {
    ...
    return (
        <>
            <div className="flex w-full bg-[rgb(9,37,59)] py-2 px-4 justify-between items-center font-semibold text-[14px] text-white lg:py-3 lg:px-[60px]">
            ...
            <Searchbar styleName="px-4 py-0 max-w-[100%] -translate-y-[12%] lg:hidden" />
        </>
    )
}
